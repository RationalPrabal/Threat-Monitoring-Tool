...
# Database
# Defined in local.py / production.py, but setting default here or handling via env
# Using valid sqlite default or dummy to allow import
DATABASES = {
    'default': {
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': str(BASE_DIR / 'logs' / 'django.log') if os.path.exists(BASE_DIR / 'logs') else 'django.log',
            'formatter': 'verbose',
        },
    },
    'root': {
